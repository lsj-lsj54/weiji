...
@TableName("friend_request") // 映射数据库表名
public class FriendRequest extends BaseEntity { // 定义类 FriendRequest，有继承

    private Long fromUserId; // 字段 fromUserId
    private Long toUserId; // 字段 toUserId
